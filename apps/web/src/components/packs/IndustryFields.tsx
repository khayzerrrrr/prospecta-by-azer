...
export interface IndustrySpec {
  ...
  contactLabel: string;
  // Pipeline stages
  pipelineStages: { name: string; color: string; emoji: string; probability: number }[];
  // Visit templates
...
export const INDUSTRIES: Record<string, IndustrySpec> = {
  education: {
    ...
    pipelineStages: [
      ...
      { name: "PO / Kontrak", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Closed Lost", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  banking: {
    ...
    pipelineStages: [
      ...
      { name: "Disbursed", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Ditolak", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  healthcare: {
    ...
    pipelineStages: [
      ...
      { name: "PO / Kontrak", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Closed Lost", color: "#6B7280", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  property: {
    ...
    pipelineStages: [
      ...
      { name: "Akad / AJB", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Batal", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  automotive: {
    ...
    pipelineStages: [
      ...
      { name: "Delivery", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Lost", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  manufacturing: {
    ...
    pipelineStages: [
      ...
      { name: "PO / Kontrak", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Gagal", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  retail: {
    ...
    pipelineStages: [
      ...
      { name: "Kontrak Supply", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Lost", color: "#6B7280", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  saas: {
    ...
    pipelineStages: [
      ...
      { name: "Closed Won", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Closed Lost", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
  ...
  distributor: {
    ...
    pipelineStages: [
      ...
      { name: "Kontrak Distribusi", color: "#10B981", emoji: "✅", probability: 100 },
      { name: "Lost", color: "#EF4444", emoji: "❌", probability: 0 },
    ],
    visitTemplates: [
      ...
      <div className="border-t border-surface-200 dark:border-surface-700 pt-3 mt-2">
        <div className="animate-pulse space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[1,2,3,4].map(i => <div key={i} className="h-10 bg-surface-100 dark:bg-surface-800 rounded-xl" />)}
          </div>
        </div>
      </div>
    );
